...
hal/CortexM1/GNU/%.o: ../hal/CortexM1/GNU/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m1 -mthumb -Os -fmessage-length=0 -ffunction-sections -fdata-sections -fno-builtin  -g -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
